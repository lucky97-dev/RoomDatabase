...
public class CourseRepository {
    ...
    private static class InsertCourseAsyncTask extends AsyncTask<CourseModal, Void, Void> {
        ...
        private InsertCourseAsyncTask(CourseModalDao dao) {
            this.dao = dao;
        }
    ...
    private static class UpdateCourseAsyncTask extends AsyncTask<CourseModal, Void, Void> {
        ...
        private UpdateCourseAsyncTask(CourseModalDao dao) {
            this.dao = dao;
        }
    ...
    private static class DeleteCourseAsyncTask extends AsyncTask<CourseModal, Void, Void> {
        ...
        private DeleteCourseAsyncTask(CourseModalDao dao) {
            this.dao = dao;
        }
    ...
    private static class DeleteAllCoursesAsyncTask extends AsyncTask<Void, Void, Void> {
        private CourseModalDao dao;
        private DeleteAllCoursesAsyncTask(CourseModalDao dao) {
            this.dao = dao;
        }
        @Override
